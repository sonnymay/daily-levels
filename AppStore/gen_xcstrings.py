...
add("The purchase couldn’t be completed. Please try again.","No se pudo completar la compra. Inténtalo de nuevo.","Não foi possível concluir a compra. Tente novamente.","Der Kauf konnte nicht abgeschlossen werden. Versuche es erneut.","L’achat n’a pas pu être finalisé. Réessaie.","購入を完了できませんでした。もう一度お試しください。")
