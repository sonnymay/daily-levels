...
- Unit tests cover midnight, DST, timezone changes, cold-launch recovery, unsafe live and persisted
  timestamps, overflow-safe focus totals, and entitlement migration.
