...
- **Interval-backed history** — daily totals, personal bests, and lifetime progress are derived from each persisted session's start/end timestamps. Redundant or inconsistent duration values cannot inflate focus, and impossible intervals are ignored without hiding valid neighboring sessions.
